				...
				<div className="max-w-4xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="font-sans text-gray-600 text-lg">
							Test your knowledge about amazing places around the world.
						</p>
					</div>
					...
					<Card className="p-8 text-center">
						...
						<p className="font-sans text-gray-600 max-w-2xl mx-auto">
							We&apos;re creating engaging quizzes about destinations, cultures,
							and hidden gems. Challenge yourself and discover new places
